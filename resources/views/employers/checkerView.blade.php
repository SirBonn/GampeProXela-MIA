        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="fixed-div-right">
                    <h1>Carrito</h1>
                    <div class="card p-2" style="height:550px">
                    ...
                    <div class="mt-2 mx-2 d-flex justify-content-between">
                        <form action="{{route('cart.sell')}}" method="POST">
                            <div class="mb-3">
                                ...
                                @csrf
                                <input type="number" class="form-control" name="nit" id="nit" aria-describedby="helpId" placeholder="" />
                                <small id="helpId" class="form-text text-muted">Help text</small>
                            </div>

                            <button type="submit" class="btn btn-outline-primary"><i class="bi bi-cart4"></i> <small>Comprar</small></button>
                        </form>
                    </div>
                </div><br>
            </div>
